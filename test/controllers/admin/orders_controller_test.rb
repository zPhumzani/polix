...
class Admin::OrdersControllerTest < ActionController::TestCase
  ...
  test "should create admin_order" do
    assert_difference('Admin::Order.count') do
      post :create, admin_order: { address: @admin_order.address, email: @admin_order.email, name: @admin_order.name, pay_type: @admin_order.pay_type }
    end
  ...
  test "should update admin_order" do
    patch :update, id: @admin_order, admin_order: { address: @admin_order.address, email: @admin_order.email, name: @admin_order.name, pay_type: @admin_order.pay_type }
    assert_redirected_to admin_order_path(assigns(:admin_order))
  end
