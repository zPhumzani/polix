...
class Admin::ProductsControllerTest < ActionController::TestCase
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post :create, admin_product: { availability: @admin_product.availability, category_id: @admin_product.category_id, color: @admin_product.color, description: @admin_product.description, make: @admin_product.make, material: @admin_product.material, price: @admin_product.price, seasion: @admin_product.seasion, size: @admin_product.size, type: @admin_product.type, user_id: @admin_product.user_id }
    end
  ...
  test "should update admin_product" do
    patch :update, id: @admin_product, admin_product: { availability: @admin_product.availability, category_id: @admin_product.category_id, color: @admin_product.color, description: @admin_product.description, make: @admin_product.make, material: @admin_product.material, price: @admin_product.price, seasion: @admin_product.seasion, size: @admin_product.size, type: @admin_product.type, user_id: @admin_product.user_id }
    assert_redirected_to admin_product_path(assigns(:admin_product))
  end
